  ...
  public: {
    Tables: {
      ...
      field_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "field_notes_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "field_notes_user_id_fkey_profiles"
            columns: ["user_id"]
            isOneToOne: false
      ...
      find_comments: {
        ...
        Relationships: [
          {
            foreignKeyName: "find_comments_find_id_fkey"
            columns: ["find_id"]
            isOneToOne: false
      ...
      gps_checkins: {
        ...
        Relationships: [
          {
            foreignKeyName: "gps_checkins_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
