              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-gray-800 rounded-2xl overflow-hidden border border-gray-700 group-hover:border-cyan-400/50 transition-all">
                    ...
                    {/* Category pill + optional Kurb text indicator */}
                    <div className="px-2.5 py-1.5 flex items-center justify-between gap-1.5 bg-gray-900/80 backdrop-blur-sm border-t border-gray-700/50">
                      <div className="flex items-center gap-1.5 min-w-0">
                        <Icon className="w-3 h-3 text-cyan-400 flex-shrink-0" />
                        <span className="text-[10px] font-semibold text-gray-300 uppercase tracking-wide truncate">
                          {store.mainCategory || 'Fashion'}
                        </span>
                      </div>
                      {storeKurbItems.length > 0 && (
                        <span className="text-[9px] text-cyan-400/60 font-medium flex-shrink-0">
                          {storeKurbItems.length} on KURB
                        </span>
                      )}
                    </div>
                  </div>
