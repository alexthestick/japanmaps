    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 text-white mb-4">
              ...
              <span className="text-lg font-bold">Lost in Transit</span>
            </div>
            <p className="text-gray-400 mb-4">
              Discover the best clothing stores in Japan. Curated for streetwear enthusiasts,
              vintage hunters, and archive collectors.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} Lost in Transit. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
