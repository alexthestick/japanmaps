      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            {/* Header Bar */}
            <div
              className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-6 mb-8 shadow-lg flex items-center justify-between"
              style={{
            ...
            >
              ...
              <input
                ...
                className="px-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600 w-80"
                style={{
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                {filteredPosts.map((post, index) => {
                  ...
                  return (
                    <article
                      key={post.id}
                      className="bg-gradient-to-br from-white to-gray-50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-3 cursor-pointer relative p-5"
                      style={{
